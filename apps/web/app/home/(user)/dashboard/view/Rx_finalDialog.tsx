...
export function RxFinalDialog({ pacienteId, userId, onSaved, trigger }: RxFinalFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const { error } = await supabase.from("rx_final").insert([
            {
                esf: form.esf,
                cil: form.cil,
                eje: form.eje,
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent className="sm:max-w-[425px]">
                    <form onSubmit={handleSubmit}>
                        <DialogHeader>
                            <DialogTitle>Agregar RX de Final</DialogTitle>
                            <DialogDescription>
                                Completa los campos para registrar una nueva receta de Final.
                            </DialogDescription>
                        </DialogHeader>
